      ...
      <div className="footer-columns">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <a href="/hriscanski-post/">{cyr(`Hrišćanski post`)}</a>
            </li>
            <li>
              <a href="/meseceve-mene/">{cyr(`Mesečeve mene`)}</a>
            </li>
            <li>
              <a href="/imenoslov/">{cyr(`Imenoslov`)}</a>
            </li>
          </ul>
        </section>
        <section>
        ...
        <section>
          <div>
            ...
            {cyr(`Pravoslavni kalendar`)}
          </div>
          <p>
            {cyr(`Pravoslavni crkveni kalendar sa pregledom praznika, svetitelja,
